...
public sealed class ThemePalette
{
    ...
    public static ThemePalette Light { get; } = new()
    {
        ...
        AccentPrimary = Color.FromArgb("#1A1A1E"),
        AccentSecondary = Color.FromArgb("#333333"),
        Danger = Color.FromArgb("#FF5252"),
        TagChipBackground = Color.FromArgb("#14000000"),
        TagChipFill = Color.FromArgb("#F0F0F2"),
        TagChipStroke = Color.FromArgb("#D1D1D6"),
        TagChipText = Color.FromArgb("#1A1A1E"),
        TagChipSelectedFill = Color.FromArgb("#1A1A1E"),
        ...
        MediaExpandIcon = "icon_expand.png",
        MediaCollapseIcon = "icon_collapse.png",
    ...
    public static ThemePalette Dark { get; } = new()
    {
        ...
        MediaExpandIcon = "icon_expand_dark.png",
        MediaCollapseIcon = "icon_collapse_dark.png",
